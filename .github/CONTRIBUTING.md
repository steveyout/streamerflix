# Contributing Guidelines for StreamerFlix
...
## Contents
- [Contributing Guidelines for StreamerFlix](#contributing-guidelines-for-StreamerFlix)
  - [Contents](#contents)
...
There are two places where to request features or report bugs:
 - GitHub Issues
 - The StreamerFlix Discord server
...
### GitHub Issues
To make a GitHub issue for StreamerFlix, please visit the [new issue page](https://github.com/sussy-code/smov/issues/new/choose) where you can pick either the "Bug Report" or "Feature Request" template.
...
GitHub issues are how we track our bugs and feature requests that will be implemented into StreamerFlix - all contributions **must** have an issue and be approved by a maintainer before a pull request can be worked on.
...
## Contributing
If you're here because you'd like to work on an issue, amazing! Thank you for even considering contributing to StreamerFlix; it means a lot :heart:
...
Our recommended development environment to work on StreamerFlix is:
...
- Keep as much as possible to the style of StreamerFlix. Look around our codebase to familiarise yourself with how we do things!
...
Language contributions help StreamerFlix massively, allowing people worldwide to use our app!
